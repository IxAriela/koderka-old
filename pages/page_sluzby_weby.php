...
<img class="imgRight" alt="WordPress logo" src="<?php echo PREFIX; ?>design/img/WordPress.png" />
...
<p>
    ...
    alespoň základy HTML. Tyto stránky jsou vhodné na prezentaci, která se nemění,
    nebo pouze výjimečně.
</p>
...
<div class="bgLight padding2">
<div class="container clearfix">
<img class="imgLeft margin1" alt="Doména; Obrázek z Pixabay od Firmbee" title="Obrázek z Pixabay od Firmbee" src="<?php echo PREFIX; ?>design/img/responsive.jpg" />
...
<h2>Ceník webů na Wordpressu</h2>
<div class="servicePackages">

    <div class="servicePackage miniPackage">
        <h3>Minimalista</h3>
        <ul>
        ...
        <div class="price">od 5 000,-</div>
    </div>
    <div class="servicePackage middlePackage">
        ...
        <div class="price">od 8 000,-</div>
    </div>
    <div class="servicePackage maxiPackage">
        <h3>Pro náročné</h3>
        <ul>
            <li>Instalace Wordpressu</li>
            <li>Nastavení šablony</li>
...
<div class="servicePackages">
    ...
    <div class="servicePackage maxiPackage inactive">
